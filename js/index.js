...
(function() {
    ...
    $.get('/data/1_1.json', function (data) {
...
(function() {
    ...
    $.get('/data/1_2.json', function (data) {
        var option = {
...
(function() {
    ...
    $.get('/data/1_4.json', function (data) {
        var option = {
            color: ["#5470c6","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#ea7ccc"],
            tooltip: {
                trigger: 'axis',
...
(function() {
    ...
    $.get('/data/1_5.json', function (data) {
        var option = {
            color: ["#5470c6","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#ea7ccc"],
            tooltip: {
                trigger: 'axis',
...
(function() {
    ...
    $.get('/data/1_6.json', function (data) {
        var option = {
            color: ["#5470c6","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#ea7ccc"],
            tooltip: {
                trigger: 'axis',
